...
<table class="table table-hover table-fa">
    ...
    <tr>
        ...
        <td>节点一</td>
        <td><a href="<@slyak.query url="/group/host"/>">编辑</a><a class="btn-link mr-3" href="<@slyak.query url="/group/host"/>">停用</a><a class="btn-link" href="<@slyak.query url='/group/delete'/>">删除</a></td>
    </tr>
    <tr>
