<@layout.group title="文件列表" btnCreate={'title':'添加文件','url':'/project/group/file'}>
<table class="table table-hover table-fa">
    ...
    <tr>
        ...
        <td>URL</td>
        <td><a class="btn-link mr-3" href="<@slyak.query url="/project/group/file"/>">编辑</a><a class="btn-link" href="<@slyak.query url='/project/group/file/delete'/>">删除</a></td>
    </tr>
    <tr>
