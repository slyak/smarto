...
<#-- @ftlvariable name="page" type="org.springframework.data.domain.Page<com.slyak.mirrors.domain.HostGroup>" -->
<@layout.layout_project title='主机分组' btnCreate={"title":"创建分组","url":"/project/group"}>
